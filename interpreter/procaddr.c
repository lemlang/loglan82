...
void hash_create ( p,size ) procdescr *p;
int size;
{
...
void hash_find ( mess,obj ) procaddr *mess;
virtaddr *obj;
{
    int i,first,jump;
    word am;
...
void hash_set ( mess,ah ) procaddr *mess;
word ah;
{
    int i,first,jump;
    word am;
...
static int hash_check_item ( ah, mess )  word ah;
procaddr *mess;
{
    word am=M[ah];
...
static void hash_new_item ( obj, mess )  virtaddr *obj;
procaddr *mess;
{
    word am;
    newarry ( 1,4,APROCESS,obj,&am );
